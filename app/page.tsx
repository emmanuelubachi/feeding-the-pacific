  ...
  const cards = [
    {
      id: 1,
      name: "Github Code",
      url: "https://github.com/emmanuelubachi/pacific-food-trade",
    },
    {
      id: 2,
      name: "Data Analysis",
  ...
  return (
    <header>
      ...
      <section className="m-0 h-[80vh] flex items-center justify-center">
        <div className="m-4 flex flex-col items-center justify-center sm:space-y-10 space-y-2 w-fit bg-pri-12/90 lg:p-6 p-4 rounded-xl">
          <div>
            <h1
              className="
                text-3xl sm:text-4xl mb-2
                font-bold xl:font-extrabold leading-none tracking-tight 
                text-stone-700"
            >
              Pacific Food Trade
            </h1>
            ...
            >
              Welcome to{" "}
              <span className="text-pri-1 uppercase font-bold">
                Pacific Food Trade
              </span>
              , our entry for the{" "}
              <span className="text-pri-13 uppercase font-bold">
                PACIFIC DATAVIZ CHALLENGE
              </span>
              . Explore this interactive platform to unlock insights into the
            ...
            <div className=" flex justify-center">
              <Link
                ...
                className="inline-flex items-center px-16 py-2.5
                  ...
                  hover:bg-pri-13 hover:scale-105 focus:ring-2 focus:outline-none focus:ring-white/60"
              >
                Get Started
              </Link>
            </div>
            <div className="flex gap-3">
              {cards.map((i) => (
                <Link
                  ...
                  href={i.url}
                  target="_blank"
                  className="inline-flex items-center sm:px-5 px-4 py-2.5
                    text-sm font-medium text-center text-white 
                    bg-pri-1/70 rounded-lg 
                    hover:bg-pri-1 focus:ring-2 focus:outline-none focus:ring-white/60"
                >
